...
// import za povezovanje frontend-a
import path from 'path';
import { fileURLToPath } from 'url';

const app = express();

// Ker uporabljamo ESM module (impotr / export), __dirname ni na voljo samodejno.
// Zato ga izračunamo iz URL-ja trenutne datoteke.
const __filename = fileURLToPath(import.meta.url);
const __dirname = path.dirname(__filename);

// To je absolutna pot do zgrajenega React front-enda.
// Po priporočilu iz učnega primera se build nahaja v mapi frontend-build
